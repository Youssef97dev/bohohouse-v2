...
const Intro = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center  py-36 tracking-widest px-8 lg:px-[300px] lg:text-[16px] text-[16px] text-center gap-8">
      <h1 className="font-minionPro font-light text-[22px] leading-[33px]">{`Experience the real vibe of Lake Lalla Takerkoust and Agafay Desert`}</h1>
